...
<a href="https://canvasjs.com" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/Hardik0307/Hardik0307/master/assets/canvasjs-charts.svg" alt="canvasjs" width="36" height="36"/> </a>
...
- 🏗 shadcn/ui tabanlı atomik Design System
- 📊 TanStack Query ile operasyonel veri yönetimi
- ⚡ Low-latency veri işleme mekanizması
...
- 🤖 "AI CFO" harcama analitik katmanı
- 📈 Enflasyon karşısı getiri hesaplama
- 💰 Çok katmanlı finansal simülasyon
...
- 🔑 API key yönetimi & rate-limiting
- ⚡ Redis tabanlı milisaniyelik yanıt
- 📍 Hiyerarşik ilişkisel veri mimarisi
...
- 🎨 White-label mağaza altyapısı
- 🛒 Merkezi yönetim paneli
- 🔄 Modüler ürün kataloğu
...
- 🔐 RBAC erişim kontrol mimarisi
- 📋 Randevu, reçete, muayene, fatura
- 🏥 Farklı profiller için özel paneller
...
<!-- Snake Animation -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/hascanb/hascanb/output/github-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/hascanb/hascanb/output/github-snake.svg" />
  <img alt="github contribution snake animation" src="https://raw.githubusercontent.com/hascanb/hascanb/output/github-snake-dark.svg" width="95%" />
</picture>
